...
*/
  ...
  var colsEdi =null;
  var newColHtml = '<div class=" float-end">'+
'<button id="bEdit" type="button" class="btn btn-sm btn-soft-success btn-circle me-2"  onclick="rowEdit(this);">' +
...
'</button>'+
'<button id="bAcep" type="button" class="btn btn-sm btn-soft-purple me-2 btn-circle"  style="display:none;" onclick="rowAcep(this);">' + 
...
'</button>'+
    '</div>';
     ...
     var saveColHtml = '<div class=" float-end">'+
'<button id="bEdit" type="button" class="btn btn-sm btn-soft-success btn-circle me-2" style="display:none;" onclick="rowEdit(this);">' +
'<i class="dripicons-pencil"></i>'+
'</button>'+
'<button id="bElim" type="button" class="btn btn-sm btn-soft-danger btn-circle" style="display:none;" onclick="rowElim(this);">' +
'<i class="dripicons-trash" aria-hidden="true"></i>'+
'</button>'+
'<button id="bAcep" type="button" class="btn btn-sm btn-soft-purple me-2 btn-circle"   onclick="rowAcep(this);">' + 
'<i class="dripicons-checkmark"></i>'+
'</button>'+
